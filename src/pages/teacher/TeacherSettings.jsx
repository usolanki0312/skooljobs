    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-borderColor bg-white p-6 shadow-sm">
        <div className="mb-5 flex items-center gap-3 border-b border-borderColor pb-4">
          <span className="rounded-xl bg-primary/10 p-2 text-primary"><Eye size={18} /></span>
          <h3 className="text-lg font-bold text-slate-800">Privacy &amp; Visibility</h3>
        </div>
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="font-bold text-slate-700">Profile Visibility</p>
            <p className="mt-1 text-sm text-slate-500">Allow verified schools to view your profile and contact you for teaching opportunities.</p>
          </div>
          <label className="relative inline-flex cursor-pointer items-center">
            <input type="checkbox" className="peer sr-only" checked={isProfileVisible} onChange={() => setIsProfileVisible(!isProfileVisible)} />
      ...
      <div className="rounded-2xl border border-borderColor bg-white p-6 shadow-sm">
        <div className="mb-5 flex items-center gap-3 border-b border-borderColor pb-4">
          <span className="rounded-xl bg-primary/10 p-2 text-primary"><Bell size={18} /></span>
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Receive interview invites and job recommendations directly to your inbox.</p>
            </div>
            <label className="relative inline-flex cursor-pointer items-center">
              <input type="checkbox" className="peer sr-only" checked={notifPrefs.email} onChange={() => setNotifPrefs(p => ({...p, email: !p.email}))} />
              <div className="peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"></div>
            </label>
          </div>
          <div className="flex items-start justify-between gap-4 border-t border-borderColor/50 pt-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Get instant text alerts for critical updates like interview confirmations.</p>
            </div>
            <label className="relative inline-flex cursor-pointer items-center">
              <input type="checkbox" className="peer sr-only" checked={notifPrefs.sms} onChange={() => setNotifPrefs(p => ({...p, sms: !p.sms}))} />
              <div className="peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"></div>
            </label>
          </div>
        </div>
      ...
      <div className="rounded-2xl border border-borderColor bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {[
            { q: "How do I apply for a job?", a: "Navigate to the 'All Jobs' section, click on a job card, and hit the 'Apply Now' button." },
            { q: "How do I update my resume?", a: "Go to the 'Resume' tab in the sidebar where you can edit your skills and experience." },
            { q: "Who can see my profile?", a: "If your profile visibility is ON, verified schools can discover you in their candidate search." },
            { q: "How do I prepare for an interview?", a: "Check the 'Interviews' section for meeting links and preparation tips." },
          ].map((faq) => (
      ...
      <div className="rounded-2xl border border-red-200 bg-white p-6 shadow-sm">
        ...
        <p className="text-sm leading-relaxed text-slate-600">
          Permanently deleting your account will remove your profile, applications, and saved jobs. This action is <strong>irreversible</strong>.
        </p>
        ...
        {deleteStep === 1 && (
          <div className="mt-5 space-y-4 rounded-xl border border-red-200 bg-red-50 p-5">
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              <span className="text-sm text-slate-700">I understand that my job applications and profile data will be permanently deleted.</span>
            </label>
            <label className="flex cursor-pointer items-start gap-3">
